...
const T = {
  en: {
    ...
    why: [
      ...
      "Professional content creation throughout the weekend",
    ...
    platinumItems: [
      ...
      "First choice of evening to host (recommended: Saturday gala)",
    ...
    eveningFriDesc: "Welcome dinner on deck",
    eveningSatDesc: "Gala evening (centrepiece)",
    eveningSunDesc: "Charity celebration with athletes",
    ctaTitle: "Interested?",
    ctaText:
  ...
  fr: {
    ...
    why: [
      ...
      "Programme de soirees avec des athletes de renom et des entrepreneurs",
      "Creation de contenu professionnel tout au long du week-end",
    ...
    platinumItems: [
      ...
      "Premier choix de soiree a animer (recommande : gala du samedi)",
    ...
    eveningVenue: "M/Y ARADOS",
    eveningFriDesc: "Diner de bienvenue sur le pont",
    eveningSatDesc: "Soiree de gala (evenement phare)",
    eveningSunDesc: "Celebration caritative avec athletes",
    ctaTitle: "Interesse ?",
    ctaText:
