...
const T = {
  en: {
    ...
    nights: "Nights", location: "Monaco Harbour", vessel: "Private Superyacht",
    nightsLabel: "Nights", locationLabel: "Location", vesselLabel: "Vessel",
    intro: "Three nights aboard Private Superyacht, berthed in Monaco harbour. Race access from the water. Evenings of cocktails, conversation and sport on deck. Three ways to be on the yacht.",
    accommodation: "Accommodation",
    accommodationTitle: "Sleep aboard",
    accommodationDesc: "Private cabins on Private Superyacht for the full GP weekend. Includes all daytime hospitality, VIP Terrace access and evening cocktail events. Fri–Mon.",
    daytime: "Daytime",
  ...
  fr: {
    ...
    nights: "Nuits", location: "Port de Monaco", vessel: "Private Superyacht",
    nightsLabel: "Nuits", locationLabel: "Lieu", vesselLabel: "Yacht",
    intro: "Trois nuits a bord du Private Superyacht, amarre dans le port de Monaco. Acces a la course depuis l'eau. Soirees de cocktails, de conversations et de sport sur le pont. Trois facons d'etre a bord.",
    accommodation: "Hebergement",
    accommodationTitle: "Dormir a bord",
    accommodationDesc: "Cabines privees sur le Private Superyacht pour tout le week-end du GP. Inclut toute l'hospitalite en journee, l'acces aux Terrasses VIP et les soirees cocktail. Ven–Lun.",
    daytime: "Journee",
