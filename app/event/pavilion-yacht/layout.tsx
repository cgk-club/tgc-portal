...
export const metadata: Metadata = {
  ...
  description: "Three nights aboard M/Y ARADOS in Monaco harbour. Private accommodation, daytime hospitality on the water, and evening cocktail dinatoire with international athletes.",
  openGraph: {
    title: "The Pavilion — Yacht · Monaco GP 2026",
    description: "Three nights aboard M/Y ARADOS. Accommodation, daytime hospitality, and evening cocktail dinatoire in Monaco.",
    type: "website",
  ...
  twitter: {
    ...
    title: "The Pavilion — Yacht · Monaco GP 2026",
    description: "Three nights aboard M/Y ARADOS in Monaco harbour.",
