      ...
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 font-body">
            {mode === "password"
              ...
              : "We will send you a secure access link"}
          </p>
        </div>
        ...
        {sent ? (
          <div className="bg-white rounded-lg border border-green/10 p-6 text-center">
            ...
            <p className="text-sm text-gray-500 font-body">
              If your email is registered as a partner, you will receive an
              access link shortly. The link is valid for 24 hours.
            </p>
          </div>
        ) : mode === "password" ? (
          <form
            onSubmit={handlePasswordLogin}
            className="bg-white rounded-lg border border-green/10 p-6 space-y-4"
          >
            <div>
              <label
                htmlFor="email"
                className="block text-xs text-gray-500 font-body mb-1"
              >
                Email
              </label>
              <input
