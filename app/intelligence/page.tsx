...
const tools = [
  ...
  },
  {
    ...
    description: 'F1, polo, golf, sailing, opera, art fairs. The difference between a hospitality package and embedded access. How to attend the right way, with the right people.',
    cta: 'Coming soon',
    live: false,
  },
  {
