...
export async function sendMagicLink(to: string, name: string, token: string) {
  ...
  await getResend().emails.send({
    ...
    text: `${name},\n\nYour portal is ready.\n\nAccess my portal: ${link}\n\nThis link is valid for 7 days. If you didn't request this, you can safely ignore it.\n\nThe Gatekeepers Club\nthegatekeepers.club`,
    html: `<div style="font-family: Georgia, serif; max-width: 480px; margin: 0 auto; padding: 40px 20px;">
      ...
      <p style="color: #888; font-size: 13px; line-height: 1.6;">This link is valid for 7 days. If you didn't request this, you can safely ignore it.</p>
