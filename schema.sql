...
CREATE POLICY "Service role full access partner_accounts" ON partner_accounts FOR ALL USING (auth.role() = 'service_role');
CREATE POLICY "Service role full access partner_magic_tokens" ON partner_magic_tokens FOR ALL USING (auth.role() = 'service_role');
CREATE POLICY "Service role full access partner_offers" ON partner_offers FOR ALL USING (auth.role() = 'service_role');
CREATE POLICY "Service role full access partner_events" ON partner_events FOR ALL USING (auth.role() = 'service_role');
CREATE POLICY "Service role full access partner_referrals" ON partner_referrals FOR ALL USING (auth.role() = 'service_role');
CREATE POLICY "Service role full access partner_content" ON partner_content FOR ALL USING (auth.role() = 'service_role');
CREATE POLICY "Service role full access fiche_edit_requests" ON fiche_edit_requests FOR ALL USING (auth.role() = 'service_role');
CREATE POLICY "Service role full access partner_availability" ON partner_availability FOR ALL USING (auth.role() = 'service_role');
