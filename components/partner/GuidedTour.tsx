...
const TOUR_STEPS: TourStep[] = [
  {
    id: 'welcome',
    title: 'Welcome to your TGC Partner Portal',
    description: 'Let us show you what you can do here.',
    target: null,
  },
  {
    id: 'navigation',
    title: 'Your Navigation',
    description: 'Your navigation bar. Access every section from here.',
    target: '#tour-partner-nav',
    position: 'bottom',
  },
  {
    id: 'fiche',
    title: 'My Fiche',
    description: 'View and edit your profile. Submit changes for review by the TGC team.',
    target: '#tour-partner-fiche',
    position: 'bottom',
  },
  {
    id: 'listings',
    title: 'Listings',
    description: 'List products for sale on our marketplace. Our guided chat ensures every listing is complete.',
    target: '#tour-partner-listings',
    position: 'bottom',
  },
  {
    id: 'offers',
    title: 'Offers',
    description: 'Create exclusive offers for TGC clients and partners.',
    target: '#tour-partner-offers',
    position: 'bottom',
  },
  {
    id: 'events',
    title: 'Events',
    description: 'Share your events with the TGC network. Upload images, set pricing tiers.',
    target: '#tour-partner-events',
    position: 'bottom',
  },
  {
    id: 'projects',
  ...
  },
  {
    ...
    target: '#tour-partner-referrals',
    position: 'bottom',
  },
  {
    id: 'content',
    title: 'Content',
    description: 'Submit stories and updates for The Concierge Chronicles consideration.',
    target: '#tour-partner-content',
    position: 'bottom',
  },
  {
    id: 'availability',
    title: 'Availability',
    description: 'Mark your available and blackout dates so we can plan around your schedule.',
    target: '#tour-partner-availability',
    position: 'bottom',
  },
  {
    id: 'toolkit',
    title: 'Toolkit',
    description: 'Download co-marketing assets and share your referral link.',
    target: '#tour-partner-toolkit',
    position: 'bottom',
  },
  {
    id: 'network',
    title: 'Network',
    description: 'See other partners in the TGC network.',
    target: '#tour-partner-network',
    position: 'bottom',
  },
  {
    id: 'finish',
    title: 'You are all set',
    description: 'Your concierge is here whenever you need us.',
    target: null,
  },
]

const STORAGE_KEY = 'tgc_partner_tour_completed'
...
export default function PartnerGuidedTour({ show, onComplete }: GuidedTourProps) {
...
export { STORAGE_KEY as PARTNER_TOUR_STORAGE_KEY }
